...
var s = function(r, s2, t2) {
  return t2 === void 0 && (t2 = {}), function(i, a, u) {
    try {
      return Promise.resolve(function(o, n2) {
        try {
          var a2 = Promise.resolve(r[t2.mode === "sync" ? "parse" : "parseAsync"](i, s2)).then(function(r2) {
        ...
        return { values: {}, errors: r2.isEmpty ? {} : f(n(r2.errors, !u.shouldUseNativeValidation && u.criteriaMode === "all"), u) };
      }));
    } catch (r2) {
